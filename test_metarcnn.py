...
if __name__ == '__main__':
    ...
    num_ways = 20
    if args.net == 'metarcnn':
        fasterRCNN = resnet(imdb.classes, num_ways, 101, pretrained=False, class_agnostic=args.class_agnostic, meta_train=False,
                            meta_test=args.meta_test, meta_loss=args.meta_loss, transductive=args.transductive)
    else:
    ...
    for i in range(num_images):
        ...
        rois_label, cls_prob_list, bbox_pred_list, _, _, _ = fasterRCNN(im_data_list, im_info_list, gt_boxes_list,
